...
int main(){
	...
	cin>>numero; 
	// Necesitamos descomponer el numero en und, dec, cent, millares.
    // Ejemplo el numero 2152 = 2000+100+50+2

    // 2152/10=215.2 -- unidades es igual al resto de la division, es decir, 2
	...
	//Utilizamos condicionales multiples para validar cada numero segun su posicion
	switch(millar){
		case 1: cout<<"M";break;
